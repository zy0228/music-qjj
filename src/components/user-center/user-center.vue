      ...
      <div class="list-wrapper" ref="listWrapper">
        <scroll ref="favoriteList" class="list-scroll" v-if="currentIndex===0" :data="favoriteList">
          <div class="list-inner">
            <song-list :songs="favoriteList" @select-item="selectSong"></song-list>
          </div>
        </scroll>
        <scroll ref="playHistory" class="list-scroll" v-if="currentIndex===1" :data="playHistory">
          <div class="list-inner">
            <song-list
              :songs="playHistory" @select-item="selectSong"
            >
            </song-list>
          </div>
        </scroll>
...
import Switches from 'base/BaseSwitches'
